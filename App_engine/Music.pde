...
void drawMusic() {
  ...
  if (ShowPlay == false && ShowPause == true){
    ...
    if (mouseX>=pauseX1 && mouseX<=playX2 && mouseY>=pauseY1 && mouseY<=playY3) stroke(redthirdsorange);
    strokeWeight(4);
    ...
    if (mouseX>=pauseX1 && mouseX<=playX2 && mouseY>=pauseY1 && mouseY<=playY3) stroke(red2thirdsorange);
    strokeWeight(2);
    line( pauseX1, pauseY1, pauseX3, playY2 );
    line( pauseX1, playY3, pauseX3, playY2 );
    line( pauseX3, playY3, pauseX1, playY2 );
  ...
  if (ShowPlay == true && ShowPause == false){
    ...
    if (mouseX>=playX1 && mouseX<=playX2 && mouseY>=playY1 && mouseY<=playY3) stroke(redthirdsorange);
    strokeWeight(4);
    ...
    if (mouseX>=playX1 && mouseX<=playX2 && mouseY>=playY1 && mouseY<=playY3) stroke(red2thirdsorange);
    strokeWeight(2);
    line( playX1, playY2, playX2, playY2);
    line( playX1, playY1, pauseX2, playY2);
    line( playX1, playY1, pauseX3, playY2);
  ...
  //
  drawStopButton();
  if ( StopOn==true ) {/*fill*/ stroke(orange); stroke(redthirdsorange); } else {/*fill*/ stroke(cyan);};
  if (mouseX>=stopX && mouseX<=stopX+stopWidth && mouseY>=stopY && mouseY<=stopY+stopHeight) /*fill*/ stroke(redthirdsorange); //redhalforange, red2thirdsorange, redthirdsorange
  strokeWeight(4);
  ...
  if (mouseX>=stopX && mouseX<=stopX+stopWidth && mouseY>=stopY && mouseY<=stopY+stopHeight) /*fill*/ stroke(red2thirdsorange); 
  strokeWeight(2);
  line( stopX, stopY, stopX3, stopY3);
  line( stopX3, stopY, stopX, stopY3);
  line( stopX, stopY2, stopX3, stopY2);
  ...
  if (mouseX>=ffX1 && mouseX<=ffX5 && mouseY>=ffY1 && mouseY<=ffY3) /*fill*/ stroke(redthirdsorange);
  strokeWeight(4);
  ...
  if (mouseX>=ffX1 && mouseX<=ffX5 && mouseY>=ffY1 && mouseY<=ffY3) /*fill*/ stroke(red2thirdsorange);
  strokeWeight(2);
  line( ffX4, ffY4, ffX2, ffY2);
  line( ffX6, ffY6, ffX2, ffY2);
  line( ffX1, ffY2, ffX5, ffY5);
  ...
  if (mouseX>=rX5 && mouseX<=rX1 && mouseY>=rY1 && mouseY<=rY3) /*fill*/ stroke(redthirdsorange);
  strokeWeight(4);
  ...
  if (mouseX>=rX5 && mouseX<=rX1 && mouseY>=rY1 && mouseY<=rY3) /*fill*/ stroke(red2thirdsorange);
  strokeWeight(2);
  line( rX4, rY4, rX2, rY2);
  line( rX6, rY6, rX2, rY2);
  line( rX4, rY2, rX5, rY5);
  ...
  if (mouseX>=skipX1 && mouseX<=skipX5 && mouseY>=skipY1 && mouseY<=skipY3) /*fill*/ stroke(redthirdsorange);
  strokeWeight(4);
  ...
  if (mouseX>=skipX1 && mouseX<=skipX5 && mouseY>=skipY1 && mouseY<=skipY3) /*fill*/ stroke(red2thirdsorange);
  strokeWeight(2);
  line( skipX1, skipY2, skipX5, skipY2);
  line( skipX2, skipY2, skipX5, skipY1);
  line( skipX2, skipY2, skipX5, skipY3);
  ...
  if (mouseX>=backX5 && mouseX<=backX1 && mouseY>=backY1 && mouseY<=backY3) /*fill*/ stroke(redthirdsorange);
  strokeWeight(4);
  ...
  if (mouseX>=backX5 && mouseX<=backX1 && mouseY>=backY1 && mouseY<=backY3) /*fill*/ stroke(red2thirdsorange);
  strokeWeight(2);
  line( backX1, backY2, backX5, backY2);
  line( backX2, backY2, backX5, backY1);
  line( backX2, backY2, backX5, backY3);
  ...
  if (mouseX>=loopX9 && mouseX<=loopX9+loopButtonWidth && mouseY>=loopY3 && mouseY<=loopY3-loopButtonHeight) /*fill*/ stroke(redthirdsorange);
  strokeWeight(4);
  ...
  if (mouseX>=loopX9 && mouseX<=loopX9+loopButtonWidth && mouseY>=loopY3 && mouseY<=loopY3-loopButtonHeight) /*fill*/ stroke(red2thirdsorange);
  strokeWeight(2);
  line( loopX1, loopY7, loopX8, loopY8);
  line( loopX8, loopY8, loopX1, loopY9);
  line( loopX7, loopY8, loopX1, loopY6);
  ...
  if (mouseX>=muteX10 && mouseX<=muteX7 && mouseY>=stopY && mouseY<=stopY+stopHeight) /*fill*/ stroke(redthirdsorange);
  strokeWeight(4);
  ...
  if (mouseX>=muteX10 && mouseX<=muteX7 && mouseY>=stopY && mouseY<=stopY+stopHeight) /*fill*/ stroke(red2thirdsorange);
  strokeWeight(2);
  line( muteX10, muteY4, muteX5, muteY5);
  line( muteX10, muteY5, muteX4, muteY4);
  line( muteX10, muteY4, muteX3, muteY3);
