...
void RandomLines() {
  ...
  line(0, random(0, height), random(0, width), 0);
  line(width, random(0, height), random(0, width), height);
  line(0, random(0, height), random(0, width), height);
  line(width, random(0, height), random(0, width), 0);
  line(random(0, width), 0, 0, random(0, height));
  line(random(0, width), height, width, random(0, height));
  line(random(0, width), height, 0, random(0, height));
  line(random(0, width), 0, width, random(0, height));
}
...
void drawButtonText() {
  ...
  rect(rX5, rY1 - rTextHeight , rTextWidth, rTextHeight);
